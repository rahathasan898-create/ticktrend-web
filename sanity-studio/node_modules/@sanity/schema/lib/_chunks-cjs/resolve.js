"use strict";
var isFinite = require("lodash/isFinite.js"), uniqBy = require("lodash/uniqBy.js");
function _interopDefaultCompat(e) {
  return e && typeof e == "object" && "default" in e ? e : { default: e };
}
var isFinite__default = /* @__PURE__ */ _interopDefaultCompat(isFinite), uniqBy__default = /* @__PURE__ */ _interopDefaultCompat(uniqBy);
...
function getCachedStringFieldPaths(type, maxDepth) {
  ...
  return type[symbol] || (type[symbol] = uniqBy__default.default(
    [
      ...BASE_WEIGHTS,
...
function normalizeMaxDepth(maxDepth) {
  return !isFinite__default.default(maxDepth) || maxDepth < 1 || maxDepth > DEFAULT_MAX_FIELD_DEPTH ? DEFAULT_MAX_FIELD_DEPTH - 1 : maxDepth - 1;
}
exports.ALL_FIELDS_GROUP_NAME = ALL_FIELDS_GROUP_NAME;
exports.DEFAULT_MAX_FIELD_DEPTH = DEFAULT_MAX_FIELD_DEPTH;
exports.DEFAULT_OVERRIDEABLE_FIELDS = DEFAULT_OVERRIDEABLE_FIELDS;
exports.OWN_PROPS_NAME = OWN_PROPS_NAME;
